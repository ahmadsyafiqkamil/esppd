...
class User
{
    ...
    //
		...
		// 		users.noti_count, users.custom_view,
		...
		// 		user_roles.banned, user_roles.ticket_manager,
		// 		user_roles.ticket_worker, user_roles.knowledge_manager,
		// 		user_roles.client, user_roles.admin_announcements,
