      ...
      <tbody>
        <?php foreach ($dataSPPD->result() as $sppd ):
          ...
          <tr>
            ...
            <td><a href="<?php echo base_url(); ?>client/cetak_spt/<?php echo $sppd->id_sppd;?>" type="button" class="btn bg-blue" target="_blank">cetak<i class="glyphicon glyphicon-print position-right"></i></a>
